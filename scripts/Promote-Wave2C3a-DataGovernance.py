...
for cid in expected:
    ...
    if not (
        x["status"]=="PASS"
        and x["sufficiency"]=="SUFFICIENT"
        and x["promotion_eligible"] is True
        and x["promotion_status"]=="QUALIFIED_NOT_PROMOTED"
        and x["remediation_state"]=="OPEN"
    ):
