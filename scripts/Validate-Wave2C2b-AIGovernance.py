...
errors=[]
promoted={"EMS-CTRL-049","EMS-CTRL-050","EMS-CTRL-053"}
...
expected=["EMS-CTRL-063","EMS-CTRL-065","EMS-CTRL-066","EMS-CTRL-080"]

if len(open_rows)!=4:
    errors.append(f"Expected 4 open controls, found {len(open_rows)}")
...
if record.get("pre_open_count")!=7 or record.get("post_open_count")!=4:
    errors.append("Population counts must reconcile 7 -> 4")
